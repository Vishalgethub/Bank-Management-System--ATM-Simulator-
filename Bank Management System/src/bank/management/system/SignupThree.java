...
public class SignupThree extends JFrame implements ActionListener {
    ...
    SignupThree(String formno) {
        ...
        r1.setBounds(350,80,250,30);
        add(r1);
        
        r2 = new JRadioButton("Fixed Account");
        r2.setFont(new Font("Raleway", Font.BOLD,16));
        r2.setBackground(Color.WHITE);
        r2.setBounds(350,120,250,30);
        add(r2);
        
        r3 = new JRadioButton("Current Account");
        r3.setFont(new Font("Raleway", Font.BOLD,16));
        r3.setBackground(Color.WHITE);
        r3.setBounds(350,160,250,30);
        add(r3);
        ...
        service.setBounds(100, 370, 200, 30);
        add(service);
        ...
        JLabel declarition = new JLabel("Declaration:");
        declarition.setFont(new Font("Raleway", Font.BOLD, 22));
        declarition.setBounds(100, 530, 200, 30);
        add(declarition);
        
        c7 = new JCheckBox("I Hereby declere that the above entered details are correct to the best of my knowledge");
        ...
        submit.setBounds(100, 610, 200, 30);
        ...
        cancel.setBounds(350, 610, 200, 30);
    ...
    public void actionPerformed (ActionEvent ae){
        if (ae.getSource() == submit){
            ...
            if(r1.isSelected()){
                ...
                accountType = "Fixed Deposit Acount";
            ...
            try {
                if (accountType.equals("")){
                    ...
                    Conn conn = new Conn();
                    String query1 = "insert into signupthree values('"+formno+"','"+accountType+"','"+cardnumber+"','"+pino+"','"+facility+"')";

                    String query2 = "insert into login values('"+formno+"','"+cardnumber+"','"+pino+"')";
